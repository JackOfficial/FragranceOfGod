...
@section('title', 'AutoSpareLink - Add Body Type')
@section('content')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Add Body Type</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-8">
            <div class="card card-primary" x-data="{ iconPreview: null }">
                <div class="card-header">
                    <h3 class="card-title">Add Body Type</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.body-types.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
