    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('focus-areas.show', 'community-outreach-care') }}" class="text-decoration-none">
            ...
            <!-- Focus Area 2 -->
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('focus-areas.show', 'youth-family-empowerment') }}" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm rounded-4 p-4">
                        <div class="icon-circle bg-warning text-dark mb-4 d-inline-flex align-items-center justify-content-center rounded-circle"
                             style="width:65px; height:65px;">
            ...
            <!-- Focus Area 3 -->
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('focus-areas.show', 'faith-discipleship') }}" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm rounded-4 p-4">
                        <div class="icon-circle bg-warning text-dark mb-4 d-inline-flex align-items-center justify-content-center rounded-circle"
                             style="width:65px; height:65px;">
            ...
            <!-- Focus Area 4 -->
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('focus-areas.show', 'economic-empowerment') }}" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm rounded-4 p-4">
                        <div class="icon-circle bg-warning text-dark mb-4 d-inline-flex align-items-center justify-content-center rounded-circle"
                             style="width:65px; height:65px;">
            ...
            <!-- Focus Area 5 -->
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('focus-areas.show', 'health-wellbeing') }}" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm rounded-4 p-4">
                        <div class="icon-circle bg-warning text-dark mb-4 d-inline-flex align-items-center justify-content-center rounded-circle"
                             style="width:65px; height:65px;">
            ...
            <!-- Focus Area 6 -->
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('focus-areas.show', 'compassion-advocacy') }}" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm rounded-4 p-4">
                        <div class="icon-circle bg-warning text-dark mb-4 d-inline-flex align-items-center justify-content-center rounded-circle"
                             style="width:65px; height:65px;">
