    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-8">
                ...
                @if(!empty($program->objectives) && is_array($program->objectives))
            ...
            <div class="col-lg-4">
                <div class="p-4 bg-light shadow-sm rounded-4">
                    ...
                    @forelse($relatedPrograms as $rel)
                        <a href="{{ route('programs.show', $rel->id) }}"
                           class="d-block mb-3 fw-bold text-decoration-none text-dark">
                            {{ $rel->title }}
                        </a>
                    @empty
                        <p class="text-muted small">No other programs available.</p>
                    @endforelse
                </div>
            </div>
