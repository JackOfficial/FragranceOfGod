...
@section('title', $project->title.' | Fragrance Of God')
...
<section class="ngo-hero position-relative d-flex align-items-center" style="min-height:400px;">
    ...
    <div class="container position-relative text-center">
        ...
        <p class="text-light lead mt-3">Learn more about our initiatives in action</p>
    </div>
</section>
    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-8">
                ...
                @if($docs->count())
                    <div class="mt-4">
                        <h5 class="fw-bold" style="color:#ffcc00;">Project Documents</h5>
                ...
                <div class="mt-5">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        <a href="https://api.whatsapp.com/send?text={{ urlencode($project->title.' '.url()->current()) }}"
                           target="_blank" class="btn btn-success">
                            <i class="fab fa-whatsapp me-2"></i> WhatsApp
                        </a>

                        <a href="mailto:?subject={{ urlencode($project->title) }}&body={{ urlencode(url()->current()) }}"
            ...
            <div class="col-lg-4">
                <div class="p-4 shadow-sm rounded-4 bg-light">
                    ...
                    @forelse($relatedProjects as $rel)
                        @php
                            $relImage = $rel->media->where('file_type','image')->first();
                        @endphp

                        <div class="d-flex align-items-center mb-3">
                            <img src="{{ $relImage ? asset('storage/'.$relImage->file_path) : asset('frontend/img/default-project.jpg') }}"
                                 class="rounded me-2"
                                 style="width:60px;height:60px;object-fit:cover;">

                            <div>
                                <a href="{{ url('/projects/'.$rel->slug) }}"
                                   class="fw-bold text-dark text-decoration-none">
                                    {{ $rel->title }}
                                </a>
                                <small class="d-block text-muted">
                                    {{ Str::limit($rel->short_desc, 50) }}
                                </small>
                            </div>
                        </div>
                    @empty
...
<section class="py-5 text-center" style="background-color:#111; color:#ffcc00;">
    <div class="container">
        ...
        <div class="d-flex justify-content-center gap-3 flex-wrap mt-4">
            <a href="/donate" class="btn btn-lg" style="background:#ffcc00;color:#111;font-weight:600;">
                Donate Now
            </a>
